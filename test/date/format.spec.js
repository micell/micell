...
describe('date/format', () => {
  ...
  it.skip('should be as the timestamp value if the first parameter is a number', () => {
    const value = 0
  ...
  it.skip('should return the expected format string if the first parameter is a Date object', () => {
